<template>
  <div class="rounded border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-black hover:border-black dark:hover:border-white transition">
